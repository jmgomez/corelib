...
var ObjectUtils = /** @class */ (function () {
    ...
    ObjectUtils.resolvePathAsArray = function (pathValue, obj) {
        ...
        var parameters = pathValue.map(function (path) { return ObjectUtils.extractValue(path, obj); });
        var params = underscore_1.default.tail(parameters);
        var val = (_a = underscore_1.default.head(parameters)).call.apply(_a, [underscore_1.default.head(params)].concat(underscore_1.default.tail(params)));
        return val;
    };
